...
const inlineIcons: Record<string, React.ComponentType<InlineIconProps>> = {
  ...
  ModelKlingSeries: createInlineLucideIcon("ModelKlingSeries", [
    [
      "path",
      {
        d: "M 10 17 L 7 14 C 7 14, 3 13, 3 8 C 3 4, 8 3, 12 3 C 16 3, 21 4, 21 8 C 21 11, 19 13, 17 14 C 15 15, 14 17, 14 19 L 14 21",
        stroke: "currentColor",
        strokeWidth: "2",
        fill: "none",
        strokeLinecap: "round",
    ...
    [
      "path",
      {
        d: "M 8 7 C 8 7, 7 9, 7 12 C 7 15, 8 17, 10 17 C 12 17, 13 15, 13 12 C 13 9, 12 7, 10 7 C 9 7, 8 7, 8 7 Z",
        stroke: "currentColor",
        strokeWidth: "2",
        fill: "none",
        strokeLinecap: "round",
  ...
  ModelViduSeries: createInlineLucideIcon("ModelViduSeries", [
    [
      "path",
      {
        d: "M 4.5 12 C 4.5 8, 7 5.5, 10 7.5 C 12 9, 12 11, 12 12 C 12 13, 12 15, 14 16.5 C 17 18.5, 19.5 16, 19.5 12",
        stroke: "currentColor",
        strokeWidth: "2",
        fill: "none",
        strokeLinecap: "round",
    ...
    [
      "path",
      {
        d: "M 19.5 12 C 19.5 16, 17 18.5, 14 16.5 C 12 15, 12 13, 12 12 C 12 11, 12 9, 10 7.5 C 7 5.5, 4.5 8, 4.5 12",
        stroke: "currentColor",
        strokeWidth: "2",
        fill: "none",
        strokeLinecap: "round",
  ...
  "component": fromLucide("Component", Component),
  History: fromLucide("History", History),
  Package: fromLucide("Package", Package),
  "sticky-note": fromLucide("StickyNote", StickyNote),
  FileSliders: fromLucide("FileSliders", FileSliders),
  Film: fromLucide("Film", Film),
  LayoutGrid: fromLucide("LayoutGrid", LayoutGrid),
  Clapperboard: fromLucide("Clapperboard", Clapperboard),
  Wand2: fromLucide("Wand2", Wand2),
  Megaphone: fromLucide("Megaphone", Megaphone),
  PlaySquare: fromLucide("PlaySquare", PlaySquare),
  MessageCircle: fromLucide("MessageCircle", MessageCircle),
  Zap: fromLucide("Zap", Zap),
  Brain: fromLucide("Brain", Brain),
  MessageSquarePlus: fromLucide("MessageSquarePlus", MessageSquarePlus),
  Pencil: fromLucide("Pencil", Pencil),
  "pencil": fromLucide("Pencil", Pencil),
  Loader2: fromLucide("Loader2", Loader2),
  Bell: fromLucide("Bell", Bell),
  Forward: fromLucide("Forward", Forward),
  Globe: fromLucide("Globe", Globe),
  Link2: fromLucide("Link2", Link2),
  ScanSearch: fromLucide("ScanSearch", ScanSearch),
  Camera: fromLucide("Camera", Camera),
  PersonStanding: fromLucide("PersonStanding", PersonStanding),
  Sun: fromLucide("Sun", Sun),
  Moon: fromLucide("Moon", Moon),
  Monitor: fromLucide("Monitor", Monitor),
  User: fromLucide("User", User),
  Crown: fromLucide("Crown", Crown),
  Infinity: fromLucide("Infinity", Infinity),
  Settings: fromLucide("Settings", Settings),
  Box: fromLucide("Box", Box),
  HelpCircle: fromLucide("HelpCircle", HelpCircle),
  AlertTriangle: fromLucide("AlertTriangle", AlertTriangle),
  LoaderCircle: fromLucide("LoaderCircle", LoaderCircle),
};

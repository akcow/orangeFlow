...
type ProCameraMoreActionsMenuProps = {
  nodeId: string;
  open: boolean;
...
// Cursor-anchored context menu (same UX as creation components).
export default function ProCameraMoreActionsMenu({
  nodeId,
  open,
  position,
  onOpenChange,
}: ProCameraMoreActionsMenuProps) {

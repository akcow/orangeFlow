...
export const SIDEBAR_CATEGORIES = [
  { display_name: "已保存", name: "saved_components", icon: "GradientSave" },
  { display_name: "豆包 AI", name: "doubao_ai", icon: "DoubaoTTS" },
  { display_name: "文本", name: "text", icon: "ToyBrick" },
  { display_name: "输入/输出", name: "input_output", icon: "Cable" },
  { display_name: "智能体", name: "agents", icon: "Bot" },
  { display_name: "模型", name: "models", icon: "BrainCog" },
  ...
  ...(ENABLE_KNOWLEDGE_BASES
    ...
    : []),
  { display_name: "向量库", name: "vectorstores", icon: "Layers" },
  { display_name: "处理", name: "processing", icon: "ListFilter" },
  ...
  { display_name: "提示词", name: "prompts", icon: "braces" },
  { display_name: "链", name: "chains", icon: "Link" },
  { display_name: "加载器", name: "documentloaders", icon: "Paperclip" },
  { display_name: "链接提取", name: "link_extractors", icon: "Link2" },
  { display_name: "输出解析", name: "output_parsers", icon: "Compass" },
  { display_name: "原型", name: "prototypes", icon: "FlaskConical" },
  { display_name: "检索器", name: "retrievers", icon: "FileSearch" },
  { display_name: "文本切分", name: "textsplitters", icon: "Scissors" },
  { display_name: "工具包", name: "toolkits", icon: "Package2" },
  { display_name: "工具", name: "tools", icon: "Hammer" },
];

export const SIDEBAR_BUNDLES = [
  { display_name: "AI/ML 接口", name: "aiml", icon: "AIML" },
  ...
  { display_name: "嵌入模型", name: "embeddings", icon: "Binary" },

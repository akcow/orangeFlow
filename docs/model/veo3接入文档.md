...
- 鉂� Don't use instructive language like*no* or*don't*. (e.g., "No walls").
- 鉁� Do describe what you don't want to see. (e.g., "wall, frame").
...
|------------------------|-----------------------------------------|----------------------------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------------|
| **Audio**              | Natively generates audio with video.    | Natively generates audio with video.                                       | 鉁旓笍 Always on                                                 | 鉂� Silent only                                                        |
